...
MESSAGES: dict[str, str] = {
    ...
    "app.analysis_depth_help": "Rapide affiche 30 offres, Standard 60, Complet 100 — toutes classées par similarité, pas seulement les meilleures.",
    ...
    "results.simple_summary": "{top} offre(s) affichée(s), classées par similarité ATS (toutes les offres analysées).",
    ...
    "pipeline.parallel_match": "Matching ATS en parallèle ({keys}) sur **{pool}** candidats — **{results}** offre(s) classée(s) par similarité.",
