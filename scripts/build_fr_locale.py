...
MESSAGES: dict[str, str] = {
    ...
    "app.analysis_depth_help": "La recherche peut trouver beaucoup d'offres en ligne. Rapide affiche uniquement les 25 meilleures, Standard 60, Complet 100.",
    ...
    "hero.dashboard.subtitle": "Consultez le détail ATS de chaque offre, filtrez par statut et générez lettres / CV adaptés.",
    ...
    # Depth
    "depth.rapide": "Rapide — 25 offres",
    "depth.standard": "Standard — 60 offres (recommandé)",
    "depth.complet": "Complet — 100 offres",
    # Matching
    ...
    "results.simple_summary": "{jobs} offre(s) trouvées en ligne — **{top}** meilleures affichées, classées par similarité ATS.",
    "results.simple_hint": "Les détails ATS, lettres, CV adaptés et candidatures sont dans le tableau de bord.",
    "results.open_dashboard": "Ouvrir le tableau de bord",
    "results.simple_title": "{count} offre(s) classée(s)",
    "results.simple_score": "ATS",
    ...
    "pipeline.filter_backfill": "Le filtre « {age} » ne laissait que {strict} offre(s). **{added}** offre(s) plus anciennes (même zone et contrat) ont été ajoutées pour viser **{target}**.",
    "pipeline.filter_shortfall": "Seulement **{kept}** offre(s) correspondent à vos filtres (zone, contrat, niveau) sur {total} trouvées — le mode d'analyse demandait **{target}**.",
    ...
    "pipeline.parallel_match": "Matching ATS en parallèle ({keys}) sur **{pool}** candidats parmi les offres en ligne — **{results}** meilleures offre(s) retenues.",
