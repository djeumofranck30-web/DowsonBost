...
MESSAGES: dict[str, str] = {
    ...
    "results.simple_hint": "Ouvrez l'offre ou préparez le dossier depuis cette liste. Le détail ATS et le suivi restent dans le tableau de bord.",
    "results.prepare_apply": "Dossier / postuler",
